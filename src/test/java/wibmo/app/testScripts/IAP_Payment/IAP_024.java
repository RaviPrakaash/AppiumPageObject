...
/**
 * The Class IAP_024 : Perform mVisa transaction and Verify immediate refunds
 * 
 * IAP_025 :  mVisa with additional bill details
 * IAP_026 :  mVisa with immediate refunds
 * 
 * 
 */
public class IAP_024 extends BaseTest 
{
	...
	public void setExecutionStatus(Method testMethod)
	{
		...
		if(this.getClass().getSimpleName().equals("IAP_024"))		
	...
	public void IAP_025()
	{
		...
		amt=mvp.enterAmtWithBilldetails(amt, merchantId);
