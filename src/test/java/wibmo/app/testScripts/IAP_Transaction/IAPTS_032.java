 ...
 */
public class IAPTS_032 extends BaseTest {

	/** The tc. */
	public String TC=getTestScenario("IAPTS_032");
	 ...
	 */
	@Test
	public void IAPTS_032()		//"Web-SDK Successful data pick up"
	{
		
		Reporter.log(getTestScenario());
		String data=getTestData("IAPTS_032");
		...
		//icpr.checkDataPickup("SUCCESS"); message hash failed for data pickup
		...
		CSR.verifyIAPTransactionDataPickupFailure(transactionid);	//To check data pickup on CSR
	}
