...
/**
 * The Class SM_010 Verify Recipient balance after Send Money.
 */
public class SM_010 extends BaseTest // ==== Verify Recipient balance after Send Money ==== //
{
	
	/** The tc. */
	public String TC=getTestScenario("SM_010");
	...
	public void SM_010()
	{
		...
		int i=0;
		String data=getTestData("SM_010");
