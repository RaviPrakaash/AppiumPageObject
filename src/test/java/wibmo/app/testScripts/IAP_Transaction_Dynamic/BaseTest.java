...
/**
 * The Class BaseTest of IAP Transaction Dynamic module.
 */
public class BaseTest extends BaseTest1 {
	...
	{
		int rc=ExcelLibrary.getExcelRowCount("./excel_lib/TestData.xls", "IAP_Transaction_Dynamic");
		
		for (int i = 0; i <= rc; i++) 
		{
			if (!ExcelLibrary.getExcelData("./excel_lib/TestData.xls", "IAP_Transaction_Dynamic",i,0).equals(" ")) 
			{
				testData.put(ExcelLibrary.getExcelData("./excel_lib/TestData.xls", "IAP_Transaction_Dynamic",i,0), ExcelLibrary.getExcelData("./excel_lib/TestData.xls", "IAP_Transaction_Dynamic",i,2));
				testScenario.put(ExcelLibrary.getExcelData("./excel_lib/TestData.xls", "IAP_Transaction_Dynamic",i,0), ExcelLibrary.getExcelData("./excel_lib/TestData.xls", "IAP_Transaction_Dynamic",i,1));
			}
		}
	}
