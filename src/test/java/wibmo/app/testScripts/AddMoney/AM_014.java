...
/**
 * The Class AM_014 Load money using other bank cards.
 */
public class AM_014 extends BaseTest // ==== Load money using other bank cards ==== //
{
	
	/** The tc. */
	public String TC=getTestScenario("AM_014");
	...
	public void AM_014() 
 	{ 
		...
		int i=0;
		String data=getTestData("AM_014");
