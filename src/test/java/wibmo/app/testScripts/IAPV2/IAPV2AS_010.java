...
/**
 * The Class IAPV2AS_010 Web-SDK Taxi-IAP with 3ds & CVV Y
 */
public class IAPV2AS_010 extends BaseTest
{

	/** The tc. */
	public String TC=getTestScenario("IAPV2AS_010");	
	 ...
	 */
	@Test
	public void IAPV2AS_010()
	{		
		Reporter.log(getTestScenario());
		String data=getTestData("IAPV2AS_010");
