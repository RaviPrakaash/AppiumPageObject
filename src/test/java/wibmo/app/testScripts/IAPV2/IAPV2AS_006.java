...
/**
 * The Class IAPV2AS_006.	V2-IAP-weboverlay with 3ds & CVV U
 *
 */
public class IAPV2AS_006 extends BaseTest  
{		
	@BeforeMethod
	 ...
	 */
	@Test
	public void IAPV2AS_006() // V2-IAP-weboverlay with 3ds & CVV U
	{
		Reporter.log(getTestScenario());
		String data=getTestData("IAPV2AS_006");
