...
/**
 * The Class IAPV2AS_016.	V2-IAP-weboverlay with 3ds & CVV U
 *
 */
public class IAPV2AS_016 extends BaseTest  
{		
	@BeforeMethod
	...
	public String TC=getTestScenario("IAPV2AS_006");	
	
	/**
	 * iapv2as 016.
	 */
	@Test
	public void IAPV2AS_016() // V2-IAP-weboverlay with 3ds & CVV U
	{
		Reporter.log(getTestScenario());
		String data=getTestData("IAPV2AS_016");
		String loginId=data.split(",")[0],cardDetails=data.split(",")[3],transactionStatusMsg,chargeStatus=data.split(",")[8];		
